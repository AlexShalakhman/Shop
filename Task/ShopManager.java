...
public class ShopManager {
    public static void storageFulfill(Warehouse warehouse){
        ...
        Product spageti = new Product("Delvavella Spagetti, 1kg", macaroni, 6);
        Product Jack_Daniels = new Product("Jack Daniels, 500ml", alcohol, 33);
        ...
        Product alienware = new Product("Alienware x16 laptop 2022, 512GB/i9", electronics, 6700);
        Product dell = new Product("Dell 26 inch monitor,, 60gh", electronics, 725);
        ...
        Product president = new Product("President, 20 sticks", tobacco, 13.22);
        ...
        Product rice = new Product("Basmatti Rice, 5kg",  kashas,23.50);
        Product milk = new Product("Milk, 3% 2.0 liters", milkProducts, 4.40);
        Product beans = new Product("Green beans, 400 gram", cans, 3.30);
